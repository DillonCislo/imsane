...
template< class Mesh, class V, class E, class F, class H > // Added by Dillon 2017/08/22
  class CStructure
  {
  public:
...
template< class M, class V, class E, class F, class H > // Added by Dillon 2017/08/22
