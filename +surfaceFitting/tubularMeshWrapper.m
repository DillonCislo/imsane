classdef tubularMeshWrapper < surfaceFitting.meshWrapper
    ...
    % a surface. This is suitable for singly-connected meshes that can be
    % parameterized by a cenerline curve and a tube-like net of
    ...
    methods
        ...
        function this = tubularMeshWrapper()
        ...
        function [embeddings, charts] = generateEmbedding(this, chartName)
            ...
            if strcmp(chartName, 'uv') || strcmp(chartName, 'sphi') 
                ...
                embeddings{1} = spcutmesh.v ;
                if strcmpi(chartName, 'uv')
                    charts{1} = spcutmesh.uv ;
                else
                    charts{1} = spcutmesh.sphi ;
                end
